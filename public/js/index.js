var concentration_chart, mellow_chart, sensor_status;

(sensor_status = function() {
  var concentrationIncrement, mellowIncrement, socket;
  ...
  return socket.on("news", function(value) {
    ...
    if (value.args && value.address === "/muse/elements/experimental/concentration") {
      app.concentrationGraphData.push([concentrationIncrement++, value.args[0]]);
    }
    if (value.args && value.address === "/muse/elements/experimental/mellow") {
      return app.mellowGraphData.push([mellowIncrement++, value.args[0]]);
    }
  });
})();

(mellow_chart = function() {
  var container, plot, series;
  container = $("#mellow-graph");
  app.mellowGraphData.push([1, 5], [2, 10], [3, 20], [4, 30]);
  series = [
    {
  ...
  app.mellowGraphData.subscribe((function(_this) {
    return function() {
...
(concentration_chart = function() {
  var container, plot, series;
  container = $("#concentration-graph");
  app.concentrationGraphData.push([[1, 5], [2, 10], [3, 20], [4, 30]]);
  series = [
    {
  ...
  app.concentrationGraphData.subscribe((function(_this) {
    return function() {
